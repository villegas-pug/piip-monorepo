...
@Entity @Table(name = "CAT_OBJETIVO_PEI_VERSION") @Getter @Setter
public class ObjetivoPeiVersionEntity {
    @Id @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqObjetivoPeiVersion")
    @SequenceGenerator(name = "seqObjetivoPeiVersion", sequenceName = "SEQ_OBJETIVO_PEI_VERSION", allocationSize = 1)
